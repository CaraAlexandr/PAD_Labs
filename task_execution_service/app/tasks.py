...
# Initialize a semaphore to limit concurrent workers
semaphore = asyncio.Semaphore(10)


async def fetch_task_and_process(task_id, socketio_instance):
...
def fetch_weather_data(location):
    import requests
    try:
        api_url = f"https://api.weatherapi.com/v1/current.json?key=YOUR_ACTUAL_API_KEY&q={location}"
